...
#define MESH_APP_NAME "mesh_simulate_node"  // App Name to use for Meshlink Instance
...
typedef struct {
  ...
  char *conf_base;
  char *test_steps_file;
} mesh_sim_config_t;

/* Node Sim Configuration to be read from command-line */
extern mesh_sim_config_t sim_config;
